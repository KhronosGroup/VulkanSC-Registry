...
<p> The <a href="https://www.khronos.org/registry/specs/1.3/styleguide.html">Vulkan Documentation and
...
<p> The <a href="https://github.com/KhronosGroup/Vulkan-Docs">
    Vulkan-Docs</a> repository contains the Asciidoctor source for the
    Vulkan SC core API specification, and for registered Vulkan SC API
    extensions. <b>Note:</b> the Vulkan SC sources are in the
    <tt>sc_main</tt> branch. The <tt>main</tt> branch of this repository
    contains the related Vulkan sources, which Vulkan SC is derived
    from.</p>
...
<!-- Generated from xml/indexExt.py in the Vulkan SC-Docs repository -->
    <!--
...
<p> For most developers, the C header files provided with a loader and/or
    ...
    KhronosGroup/VulkanSC-Headers</a> repository. These headers also include a
    C++ header generated from the <a href="#vulkan-hpp"> VulkanSC-Hpp</a>
    project. </p>

<p> VulkanSC-Headers also includes a <a
...
<p> All Vulkan SC headers provided by Khronos are ultimately generated from
    the <tt>sc_main</tt> branch of the <a href="#repo-docs"> Vulkan-Docs</a>
    repository. If the headers in VulkanSC-Headers aren't sufficient, you
    may clone the Vulkan-Docs repository and generate headers yourself,
    following instructions there. If you need to generate a customized
    version of the headers, modify the <a href="#apiregistry">API
    Registry</a> and scripts under <b>xml/</b>. </p>
...
<p> Note: there are two static headers included in Vulkan-Docs,
    ...
    that are not generated from the Vulkan SC-Docs repository. </p>
...
<p> The Registry is in an XML file called <b>vk.xml</b> and currently
    ...
    href="#repo-docs">Vulkan-Docs</a> repository under <b>xml/</b>. This
    directory also includes a formal RELAX&nbsp;NG XML schema and scripts
    used to generate the various outputs. </p>

<p> <a href="https://www.khronos.org/registry/specs/1.3/registry.html">
...
<ul>
<li> The <a href="https://github.com/KhronosGroup/VulkanSC-Headers"
     id="vulkan-headers"> VulkanSC-Headers</a> repository contains a copy of
     the Vulkan SC XML API Registry and scripts for processing it, taken
     from the latest public specification update in the <a
     href="#repo-docs"> Vulkan-Docs</a> project, and the corresponding
     generated Vulkan SC API headers. </li>
...
<li> The <a href="https://github.com/KhronosGroup/VulkanSC-ValidationLayers"
     ...
     the Khronos official VulkanSC validation layers for Windows, Linux,
     Android, and MacOS. </li>
<li> The <a href="https://github.com/KhronosGroup/VulkanSC-Loader"
     id="vulkan-loader"> Vulkan SC-Loader</a> repository contains the
     VulkanSC loader that is used for Linux, Windows, MacOS, and iOS. </li>
</ul>
...
<p> For the Vulkan SC Specification or other documentation and tools, file an
